def lab1():
    ...
    class Restaurant:
        ...
        def describe_restaurant(self):
            print(f'Название ресторана: {self.restaurant_name}, кухня: {self.cuisine_type} корейская')
        def open_restoraunrt(self):
            print('Ресторан сейчас открыт')

    new_Restaurant = Restaurant('HANGUKGO', '')
...
def lab2():
    ...
    new_Restaurant = Restaurant('HANGUKGO', 'корейская')

    new_Restaurant2 = Restaurant('BELISSIMO', 'итальянская')

    new_Restaurant3 = Restaurant('ПАЛЬЧИКИ ОБЛИЖЕШЬ', 'русская')
...
def lab3():
    class Restaurant:
        ...
        def describe_restaurant(self):
            print(f'Название ресторана: {self.restaurant_name}, кухня: {self.cuisine_type} корейская, рейтинг ресторана: {self.rating_restaurant}')
        def open_restoraunrt(self):
            print('Ресторан сейчас открыт')
        def rrating_restaurant(self):
            print(f'Новый рейтинг ресторана: {input("Введите новый рейтинг: ")}')

    new_Restaurant = Restaurant('HANGUKGO', '', 4)
